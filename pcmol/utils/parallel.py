...
def parallel_apply(function, dataframe, column: str=None, n_jobs=16, chunk_size=32, **kwargs):
    """
    ...
    try:
        with Pool(n_jobs) as pool:
            ...
            subdivisions = [dataframe.iloc[i*chunk_size:(i+1)*chunk_size] for i in range(n_chunks)]
